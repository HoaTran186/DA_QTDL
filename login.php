...
<head>
    ...
    <link rel="stylesheet" href="/DA_QTDL/assets/vendor/font-awesome/font-awesome-4.7.0/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="/DA_QTDL/assets/vendor/bootstrap/css/bootstrap.min.css" type="text/css">
...
<body>
    <?php if (isset($_SESSION['dadangnhap']) && $_SESSION['dadangnhap'] == true) : ?>
        <h6>Bạn đang đăng nhập bạn có muốn <a href="./logout.php">Đăng xuất</a> không?</h6>
    <?php else : ?>
        <div class="wrapper" id="wrapper">
            <form action="" method="post" name="frmDangNhap" id="frmDangNhap">
                ...
                <div class="register-link">
                    <p>Thành viên mới?<a href="./register.php"> Đăng kí</a> tại đây</p>
                </div>
            </form>
            <!-- <div role="alert"></div> -->
            <?php
            ...
            if (isset($_POST['btnDangNhap'])) {
                ...
                $sqlDN = "SELECT * FROM khachhang  WHERE kh_tendangnhap = '$kh_tendangnhap' 
                ...
                if (!empty($dataKH)) {
                    ...
                    if ($_SESSION['kh_quantri'] == 1) {
                        echo '<script>location.href = "/DA_QTDL/dashboard.php"</script>';
                    } else {
                        echo '<script>location.href = "/DA_QTDL/dashboard.php"</script>';
                    }
                } else {
